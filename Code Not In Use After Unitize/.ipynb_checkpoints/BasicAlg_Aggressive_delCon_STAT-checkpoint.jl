                ...
                while continuePartition == true #myCounter < partitionCounter 
                    ...
                    for k in K_k
                        ...
                        if gx - hx <= delta2
                            ...
                            df_temp_k = df_constraints |> 
                            @filter(_.CELL == k && _.STAT == 1)|> DataFrame ##Only copy `active' paths
...
println("BasicAlg_ADelCon_CopySTAT1_"*dataSet, "; Ins ", Ins, "; β ",β,"; Time ", total_time, "; MP_obj ", MP_obj, "; x_now ", findall(x_now.==1),"; Cells ", nrow(df_cell), "; Iter ", iter)#, "; W ", LB_w, "; Cuts ", numConv)

timesFile = open("./OutputFile/BasicAlg_ADelCon_CopySTAT1_"*dataSet*".txt", "a")
