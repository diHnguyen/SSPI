...
LB_global = 0
MIP_abs = (MP_obj - LB_global)*MIP_GAP
print("MIP_abs = ", MIP_abs)
recalc_h = True
# print("df_cell")
# print(df_cell.g)
# print(df_cell)
    ...
    while (len(K_bar)>0):
        ...
        if m.status == 2:
            ...
            if set(x_index) == set(x_init):
                ...
                x_consecutive = 0
            print("x_consecutive ", x_consecutive)
            numCells_skipped = 0
            if x_consecutive >= 5:
                isWarmStart = True
            # if iter > 20:
            ...
            if runningTest == False:
                if printIters == True:
                    with open(directory+'Dec2024_Output/Iter/main_singleCut_combinedStratV1_WarmStart_threshold_p_skipSmallCells_'+density+'_'+testSet+'_'+sys.argv[2]+'.txt','a') as the_file:
        ...
        MIP_abs = (MP_obj - LB_global)*MIP_GAP/(newCell+1)
        # if iter == 8:
        #     sys.exit()
...
if runningTest == True:
    ...
    with open(directory+'./Dec2024_Output/'+'main_singleCut_combinedStratV1_WarmStart_threshold_p_skipSmallCells_'+density+'_'+testSet+'_'+sys.argv[2]+'.txt','a') as the_file:
