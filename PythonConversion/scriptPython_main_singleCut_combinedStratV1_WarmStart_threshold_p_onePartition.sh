...
do
    ...
    do
        ...
        do
            ...
            gtimeout -k 5 3600 python main_singleCut_combinedStratV1_WarmStart_threshold_p_onePartition.py $N $i $density
    ...
    for N in 40;
    do
        for i in 4 8 16 27 33 36 37 48 64 68 2 14 18 22 24 38 39 40 56 76;
        do
            echo "Running N=$N density=$density i=$i "
            gtimeout -k 5 3600 python main_singleCut_combinedStratV1_WarmStart_threshold_p_onePartition.py $N $i $density
            # gtimeout -k 5 2s sleep $((i*10)) && echo "Hello"
    ...
    for N in 50;
    do
        for i in 18 26 46 73 93 98 110 113 122 124 1 3 4 5 8 9 11 12 19 20;
        do
            echo "Running N=$N density=$density i=$i "
            gtimeout -k 5 3600 python main_singleCut_combinedStratV1_WarmStart_threshold_p_onePartition.py $N $i $density
            # gtimeout -k 5 2s sleep $((i*10)) && echo "Hello"
