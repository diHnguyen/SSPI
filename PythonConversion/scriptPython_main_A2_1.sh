...
#>60min
#N30: 3 35 36 37 52 63 64 150 282 319 xxx
#N40: 2 14 18 22 24 38 39 40 56 76 xxx
#N50: 1 3 4 5 8 9 11 12 19 20 xxx

for density in 15;
do
    for N in 30;
    do
        for i in 3 35 36 37 52 63 64 150 282 319;
        do
    ...
    for N in 40;
    do
        for i in 2 14 18 22 24 38 39 40 56 76;
        do
            echo "Running N=$N density=$density i=$i "
            gtimeout -k 5 3600 python main_A3_0.py $N $i $density
            # gtimeout -k 5 2s sleep $((i*10)) && echo "Hello"
